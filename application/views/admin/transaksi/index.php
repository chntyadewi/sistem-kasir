  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb breadcrumb-custom mb-0">
      <li class="breadcrumb-item">
        <a href="<?php echo site_url('admin/dashboard'); ?>">Beranda</a>
      </li>
      ...
      <div class="col-md-4">
        <div class="card shadow-sm border-0 rounded-3 h-70 d-flex flex-column">
          ...
          <div class="card-body flex-grow-1 d-flex flex-column">
            <form id="transaction-form" action="<?php echo site_url('admin/transaksi/process'); ?>" method="post" class="d-flex flex-column h-100">
