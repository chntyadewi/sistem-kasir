    ...
    <div class="container mt-4">
      <div class="card shadow-sm rounded-3" style="border-top: 4px solid #E07A5F; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.08);">
        <div class="card-body">
          ...
          <form method="post" action="<?= base_url('kasir/profile/update') ?>" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-3 text-center mb-3">
                <img 
                  src="<?= base_url('uploads/profile/kasir/' . (!empty($user->gambar) ? $user->gambar : 'pic.jpg')) ?>" 
                  width="178" 
                  height="178" 
