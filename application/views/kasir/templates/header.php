  ...
  <div class="sidebar-wrapper scrollbar scrollbar-inner" style="padding-top: 0;">
    <div class="sidebar-content" style="padding-top: 0; margin-top: 0;">
      <ul class="nav nav-secondary" style="position: relative; top: 0px;">
          ...
          <!-- Dashboard -->
          <li class="nav-item">
            <a href="<?php echo site_url('kasir/dashboard'); ?>">
          ...
          <!-- Laporan -->
          <li class="nav-item">
            <a href="<?php echo site_url('kasir/riwayat'); ?>">
          ...
          <nav class="navbar navbar-header navbar-header-transparent navbar-expand-lg border-bottom">
            <div class="container-fluid">
              ...
              <nav class="navbar navbar-header-left navbar-expand-lg p-0 d-none d-lg-flex">
                <a href="<?php echo site_url('kasir/dashboard'); ?>" class="btn btn-home" title="Home">
              ...
              <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                  ...
                  >
                    <div class="avatar-sm">
                      <img
                        src="<?php echo base_url('uploads/profile/kasir/' . (!empty($user->gambar) ? $user->gambar : 'pic.jpg')); ?>"
                        alt="Profile Picture"
                  ...
                  <ul class="dropdown-menu dropdown-user animated fadeIn">
                    <div class="dropdown-user-scroll scrollbar-outer">
                      ...
                      <li>
                        ...
                        <a class="dropdown-item" href="<?= base_url('kasir/profile') ?>">Perbarui Profil</a>
                        <div class="dropdown-divider"></div>
